...
const Home = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const { title, amount, age, description, category, date, transactionType } = values;

    if (!title || !amount || !age || !description || !category || !date || !transactionType) {
    ...
    <div className="home-page">
      ...
      {loading ? (
        ...
        <Container className="mt-3">
          ...
          <div className="containerBtn d-flex gap-2">
